              ...
              <div class="col-sm-8 col-sm-offset-2">
                   ...
                   <!-- 공지사항 -->
                    <div class="customer" style="float: left;">
              	         <header>
             			 <h1 style="color: #2f4f4e; margin-top: 50px; text-align: center; margin-bottom: 43.98px; ">고객삭제글</h1>
        				 </header>
						<div id="page-wrapper">
							<div class="row">
								<div class="col-lg-12">
									<div class="btn-group btn-group-justified" role="group" aria-label="..." >
										  ...
										  <div class="btn-group" role="group" >
										    <button id="customerBtn" type="button" class="btn btn-default btn-lg" style="color:#2f4f4e; font-size: 15px;"><strong>고객문의글</strong></button>   
										  </div>
										  <div class="btn-group" role="group">
										    <button  id="deleteAll" type="button" class="btn btn-default btn-lg" style="color:#2f4f4e; font-size: 15px;"><strong>고객삭제글</strong></button> 
										  </div>
									</div>
									...
									<div class="panel panel-default" style="width:100%;text-align:center; border: 3px solid #22d3d6;">
											...
											<tbody>
												<c:forEach items="${delCustomerList}" var="Customer" varStatus="status">
												<c:set var="i" value="${pagingCCreator.rowAmounTotal - (10 * (pagingCCreator.qnaPagingDTO.pagingNum-1)) }" />
														<tr  style="background-color:Moccasin; cursor: pointer;">
...
$("#deleteBtn").on("click", function () {
	...
	frmSendValue.attr("action", "${contextPath}/QnABoard/removeAll");
	frmSendValue.submit();
