...
public class MyBoardControllerTests {
    ...
    public void testShowProductList() throws Exception {
        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/allmybeauty/list")
//                                                       .param("pageNum", "5")    //페이징 테스트 시 추가
//                                                       .param("rowAmount", "10") //페이징 테스트 시 추가
                                 )
                        .andReturn()
                        .getModelAndView()
                        .getModelMap()); //목록정보 볼때 사용
    }
...
//        String resultPage = mockMvc.perform(MockMvcRequestBuilders
//                                           .post("/myboard/delete")
//                                           .param("bno", "23"))  //5로 변경 후, 한 번 더 테스트 수행
//                                   .andReturn()
//                                   .getModelAndView()
//                                   .getViewName();
//        log.info(resultPage);
